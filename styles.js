const heroTitle = document.querySelector('.logo-hero');
const heroSubtitle = document.querySelector('.hero-subtitle');
const navRibalta = document.querySelector('.logo-img');
...
window.addEventListener('scroll', () => {
  ...
  const heroScale = 1 - progress * 0.9;
  ...
  if (heroRect.top < navbarHeight) {
    ...
    const navScale = 0.8 + progress * 0.2; 
